...
import { PaiXmlExportService } from '../../services/pai-xml-export.service';

@Component({
  selector: 'app-pai-pending',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './pai-pending.component.html',
  styleUrl: './pai-pending.component.scss',
})
export class PaiPendingComponent implements OnInit {
  caseId = '';
  subjectId = '';
  sessionId = '';
  ...
  constructor(
    ...
    private xmlExport: PaiXmlExportService,
  ) {}
